...
const commands = [
  new SlashCommandBuilder()
    .setName("ping")
    .setDescription("בודק אם Forzush Bot עובד"),
  ...
  new SlashCommandBuilder()
    .setName("staff-panel")
    .setDescription("שולח את פאנל הגיוס לצוות של Forzush"),

  new SlashCommandBuilder()
    .setName("setup-xp-shop")
    .setDescription("שולח את פאנל ה-XP Shop של Forzush"),
...
async function deployCommands() {
  try {
    ...
    console.log(
      `🔄 Registering ${commands.length} Forzush slash commands...`
    );
